...
- **Vider une piste se fait depuis sa rangée.** Un bouton **V**, contre M et S. Auparavant un bouton *Effacer piste* attendait tout en bas, dans la barre d'export, et agissait sur la piste *en cours d'édition* : vider la nappe demandait de la choisir d'abord, de descendre chercher le bouton, puis de remonter — trois gestes pour un, et rien à l'écran ne disait sur quoi il allait tomber. Le V l'efface dans **tous les motifs**, A à D — vider une piste veut dire la faire taire pour de bon, pas seulement sous les yeux — et un seul Ctrl+Z rend le tout, puisque c'est un geste et non quatre.
