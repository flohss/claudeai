...
Usage :
    python -m modules.module9_special
...
def entrainer(vitesse_apprentissage=0.1, nb_essais=4000, details=False,
    ...
    if type_lecon == "categories":
        ...
        sauvegarder_checkpoint("module9_special_categories.json", {
    ...
    sauvegarder_checkpoint("module9_special_nombre.json", {
        "type_lecon": "nombre",
...
def construire_analyseur():
    analyseur = argparse.ArgumentParser(description="Module 9 : vous enseignez quelque chose a l'IA a partir de zero.")
