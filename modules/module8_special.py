"""
MODULE 8 — SPECIAL : c'est vous le professeur
================================================
...
Usage :
    python -m modules.module8_special
...
def entrainer(vitesse_apprentissage=0.1, nb_essais=4000, details=False,
    ...
    if type_lecon == "categories":
        ...
        sauvegarder_checkpoint("module8_special_categories.json", {
    ...
    sauvegarder_checkpoint("module8_special_nombre.json", {
        "type_lecon": "nombre",
...
def construire_analyseur():
    analyseur = argparse.ArgumentParser(description="Module 8 : vous enseignez quelque chose a l'IA a partir de zero.")
